...
class TimerScreenBackup extends StatefulWidget {
  final String boardId;
  final String boardName;
  final List<SwitchDevice> switches;

  const TimerScreenBackup({
    Key? key,
  ...
  @override
  State<TimerScreenBackup> createState() => _TimerScreenBackupState();
}

class _TimerScreenBackupState extends State<TimerScreenBackup> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.boardName} Timers (Complete)'),
        actions: [
